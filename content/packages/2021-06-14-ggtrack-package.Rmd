...
<div style="float: right;"><img src="../../img/ggtrack-logo.svg" width="280px"></div>
...
You can find the source code at https://github.com/mrjoh3/ggtrack and the documentation at https://mrjoh3.github.io/ggtrack/
...
```{r example, fig.width=8, fig.height=4, out.width="100%", fig.align='center', fig.retina=2, message=FALSE, warning=FALSE}
library(ggtrack)
library(ggplot2)
library(grid)
library(rWBclimate)
